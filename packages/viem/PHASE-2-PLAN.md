...
- **Build on viem.** If viem, Ox or BTX already does something, use it; do not add a layer on top. Follow viem's conventions for actions, decorators, chain formatters, errors and retries. Where viem's own function cannot be used, mirror its steps.
