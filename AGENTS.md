...
- Public `encrypt` always uses the platform CSPRNG. Only fixtures and tests call the internal `encryptWithRandom` or `encryptPadded` helpers with fixed seeds and nonce scalars.
